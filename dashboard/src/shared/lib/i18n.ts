...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'sessions.detail.promptRedacted': '프롬프트가 수집되지 않았습니다. OTEL_LOG_USER_PROMPTS=1 설정이 필요합니다.',
  ...
  en: {
    ...
    'sessions.detail.promptRedacted': 'Prompt not collected. Set OTEL_LOG_USER_PROMPTS=1 to enable.',
