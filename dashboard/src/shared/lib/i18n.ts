...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'settings.agentTheme.default': '기본',
    'settings.agentTheme.claude': 'Claude',
    'settings.agentTheme.codex': 'Codex',
    'settings.agentTheme.gemini': 'Gemini',
    ...
    'settings.agents.collection.title': '수집 상태',
    'settings.agents.collection.description': '에이전트별 마지막 데이터 수신 시간과 오늘 수집 건수를 확인합니다.',
    'settings.agents.collection.comingSoon': '수집 상태 모니터링 기능이 곧 제공됩니다.',

    // Settings — Data section
    'settings.data.export.title': '내보내기',
    'settings.data.export.description': '모니터링 데이터를 CSV 또는 JSON으로 내보냅니다.',
    'settings.data.export.comingSoon': 'CSV/JSON 내보내기 기능이 곧 제공됩니다.',
    'settings.data.cleanup.title': '데이터 정리',
    'settings.data.cleanup.description': '기간별/에이전트별 데이터를 삭제합니다.',
    'settings.data.cleanup.comingSoon': '데이터 정리 기능이 곧 제공됩니다.',
    'settings.data.dbstats.title': 'DB 통계',
    'settings.data.dbstats.description': '데이터베이스 파일 크기 및 테이블별 레코드 수를 확인합니다.',
    'settings.data.dbstats.comingSoon': 'DB 통계 기능이 곧 제공됩니다.',
    ...
    'onboarding.agent.manualSetup': '수동 설정 가이드',
    ...
    'tools.chart.callsUnit': '회',
    'tools.chart.okUnit': '성공',
    'tools.chart.failUnit': '실패',
    'tools.chart.avgPrefix': '평균 ',
    'tools.scope.project': '프로젝트',
    'tools.scope.global': '전역',

    // Rules page
    'rules.subtitle': '에이전트 지침 파일',
    'rules.loading': '로딩 중...',
    'rules.empty': '지침 파일을 찾을 수 없습니다.',
    ...
    'user.subtitle': '사용자 홈 에이전트 지침 파일',
    ...
    'dashboard.unusedTools.title': '미활용 도구',
    'dashboard.unusedTools.count': '{0}개 미활용',
    'dashboard.unusedTools.agents': '에이전트',
    'dashboard.unusedTools.skills': '스킬',
    'dashboard.unusedTools.mcp': 'MCP 서버',
    'dashboard.unusedTools.viewAll': '도구 페이지에서 확인 →',
    ...
    'impact.category.all': '전체',
    'impact.category.rules': '규칙',
    'impact.category.tools': '도구',
    ...
    'rules.tocToggle': '목차',
    'rules.search.placeholder': '검색...',
    'rules.search.prev': '이전 결과',
    'rules.search.next': '다음 결과',
    'rules.search.close': '검색 닫기',
    'rules.frontmatter.title': '제목',
    'rules.frontmatter.name': '이름',
    'rules.frontmatter.description': '설명',
    'rules.frontmatter.date': '날짜',
    'rules.frontmatter.author': '작성자',
    'rules.frontmatter.type': '유형',
    'rules.frontmatter.tags': '태그',
    'rules.frontmatter.version': '버전',
    'rules.frontmatter.model': '모델',
    'rules.code.copy': '코드 복사',
    ...
    'sessions.event.apiRequest': 'API Request',
    'sessions.event.tool': 'Tool:',
    'sessions.event.unknown': 'unknown',
    'sessions.event.fail': '[FAIL]',
    'sessions.event.userPrompt': 'User Prompt',
    'sessions.event.toolDecision': 'Tool Decision:',
    'sessions.event.apiError': 'API Error',
    'sessions.event.decision': 'Decision:',

    // Waterfall column headers & tooltip labels
    'sessions.waterfall.name': '이름',
    'sessions.waterfall.timeline': '타임라인',
    'sessions.waterfall.duration': 'Duration',
    'sessions.waterfall.model': 'Model',
    'sessions.waterfall.input': 'Input',
    'sessions.waterfall.output': 'Output',
    'sessions.waterfall.cache': 'Cache',
    'sessions.waterfall.costLabel': 'Cost',
    'sessions.waterfall.toolLabel': 'Tool',

    // Usage page tabs
    'usage.tab.cost': '비용',
    'usage.tab.tokens': '토큰',
    'usage.tab.models': '모델',
    'usage.tab.efficiency': '효율성',
    'usage.tab.impact': '영향',

    // Usage — Cost tab
    'usage.kpi.totalCost': '총 비용',
    'usage.kpi.dailyAverage': '일평균',
    'usage.kpi.perDay': '일별',
    'usage.kpi.requests': '요청수',
    'usage.kpi.apiRequests': 'API 요청',
    'usage.chart.dailyCostTrend': '일별 비용 추이',
    'usage.chart.costByAgent': '에이전트별 비용',
    'usage.chart.costByProject': '프로젝트별 비용',
    'usage.noProjectData': '프로젝트 데이터 없음',

    // Usage — Tokens tab
    'usage.kpi.totalTokens': '총 토큰',
    'usage.kpi.inputOutputCache': '입력 + 출력 + 캐시',
    'usage.kpi.inputOutputRatio': '입력/출력 비율',
    'usage.kpi.inputProportion': '입력 비율',
    'usage.kpi.cacheSavings': '캐시 절감',
    'usage.kpi.tokensFromCache': '캐시에서 제공된 토큰',
    'usage.chart.dailyTokenUsage': '일별 토큰 사용량',
    'usage.chart.tokenDistByAgent': '에이전트별 토큰 분포',
    'usage.token.input': '입력',
    'usage.token.output': '출력',
    'usage.token.cacheRead': '캐시',

    // Usage — Models tab
    'usage.col.model': '모델',
    'usage.col.agent': '에이전트',
    'usage.col.reqs': '요청',
    'usage.col.cost': '비용',
    'usage.col.avgPerReq': '요청당 평균',
    'usage.chart.modelUsage': '모델 사용 현황',
    'usage.noModelData': '모델 데이터 없음',
    'usage.chart.costByModel': '모델별 비용',
    'usage.chart.requestsByModel': '모델별 요청수',
    'usage.totalAcrossModels': '총 {cost} · {count}개 모델',

    // Usage — Efficiency tab
    'usage.kpi.cacheHitRate': '캐시 히트율',
    'usage.kpi.cacheReadDesc': 'cache_read / 총 입력',
    'usage.kpi.avgResponseTime': '평균 응답 시간',
    'usage.kpi.perApiRequest': 'API 요청당',
    'usage.kpi.efficiencyScore': '효율성 점수',
    'usage.kpi.compositeScore': '복합 점수 (0-100)',
    'usage.col.cacheRate': '캐시율',
    'usage.col.tokenEff': '토큰 효율',
    'usage.col.avgSpeed': '평균 속도',
    'usage.col.score': '점수',
    'usage.chart.efficiencyTrend': '효율성 추이',
    'usage.chart.efficiencyByAgent': '에이전트별 효율성',
    'usage.noEfficiencyData': '효율성 데이터 없음',

    // Usage — Impact tab metric labels
    'usage.impact.avgCost': '평균 비용',
    'usage.impact.avgTokens': '평균 토큰',
    'usage.impact.cacheRate': '캐시율',
    'usage.impact.toolSuccess': '도구 성공률',
    'usage.impact.avgDuration': '평균 소요',
    'usage.impact.reqsPerSession': '세션당 요청',
  },
  en: {
    // Nav
    ...
    'settings.agentTheme.default': 'Default',
    'settings.agentTheme.claude': 'Claude',
    'settings.agentTheme.codex': 'Codex',
    'settings.agentTheme.gemini': 'Gemini',
    ...
    'onboarding.agent.manualSetup': 'Manual Setup Guide',
    ...
    'tools.chart.callsUnit': 'calls',
    'tools.chart.okUnit': 'ok',
    'tools.chart.failUnit': 'fail',
    'tools.chart.avgPrefix': 'avg ',
    'tools.scope.project': 'project',
    'tools.scope.global': 'global',

    // Rules page
    'rules.subtitle': 'Agent instruction files',
    'rules.loading': 'Loading...',
    'rules.empty': 'No instruction files found.',
    ...
    'user.subtitle': 'User home agent instruction files',
    ...
    'dashboard.unusedTools.title': 'Unused Tools',
    'dashboard.unusedTools.count': '{0} unused',
    'dashboard.unusedTools.agents': 'Agents',
    'dashboard.unusedTools.skills': 'Skills',
    'dashboard.unusedTools.mcp': 'MCP Servers',
    'dashboard.unusedTools.viewAll': 'View in Tools page →',
    ...
    'projects.tab.rules': 'Instructions',
    ...
    'impact.category.all': 'All',
    'impact.category.rules': 'Rules',
    'impact.category.tools': 'Tools',
    ...
    'rules.tocToggle': 'TOC',
    'rules.search.placeholder': 'Search...',
    'rules.search.prev': 'Previous result',
    'rules.search.next': 'Next result',
    'rules.search.close': 'Close search',
    'rules.frontmatter.title': 'Title',
    'rules.frontmatter.name': 'Name',
    'rules.frontmatter.description': 'Description',
    'rules.frontmatter.date': 'Date',
    'rules.frontmatter.author': 'Author',
    'rules.frontmatter.type': 'Type',
    'rules.frontmatter.tags': 'Tags',
    'rules.frontmatter.version': 'Version',
    'rules.frontmatter.model': 'Model',
    'rules.code.copy': 'Copy code',
    ...
    // Waterfall column headers & tooltip labels
    'sessions.waterfall.name': 'Name',
    'sessions.waterfall.timeline': 'Timeline',
    'sessions.waterfall.duration': 'Duration',
    'sessions.waterfall.model': 'Model',
    'sessions.waterfall.input': 'Input',
    'sessions.waterfall.output': 'Output',
    ...
    'usage.tab.efficiency': 'Efficiency',
    'usage.tab.impact': 'Impact',

    // Usage — Cost tab
    'usage.kpi.totalCost': 'Total Cost',
    'usage.kpi.dailyAverage': 'Daily Average',
    'usage.kpi.perDay': 'per day',
    'usage.kpi.requests': 'Requests',
    'usage.kpi.apiRequests': 'API requests',
    'usage.chart.dailyCostTrend': 'Daily Cost Trend',
    'usage.chart.costByAgent': 'Cost by Agent',
    'usage.chart.costByProject': 'Cost by Project',
    'usage.noProjectData': 'No project data',

    // Usage — Tokens tab
    'usage.kpi.totalTokens': 'Total Tokens',
    'usage.kpi.inputOutputCache': 'input + output + cache',
    'usage.kpi.inputOutputRatio': 'Input / Output Ratio',
    'usage.kpi.inputProportion': 'input proportion',
    'usage.kpi.cacheSavings': 'Cache Savings',
    'usage.kpi.tokensFromCache': 'tokens served from cache',
    'usage.chart.dailyTokenUsage': 'Daily Token Usage',
    'usage.chart.tokenDistByAgent': 'Token Distribution by Agent',
    ...
    'usage.col.reqs': 'Reqs',
    'usage.col.cost': 'Cost',
    'usage.col.avgPerReq': 'Avg/req',
    'usage.chart.modelUsage': 'Model Usage',
    'usage.noModelData': 'No model data',
    'usage.chart.costByModel': 'Cost by Model',
    'usage.chart.requestsByModel': 'Requests by Model',
    'usage.totalAcrossModels': 'Total: {cost} across {count} model(s)',

    // Usage — Efficiency tab
    'usage.kpi.cacheHitRate': 'Cache Hit Rate',
    'usage.kpi.cacheReadDesc': 'cache_read / total input',
    'usage.kpi.avgResponseTime': 'Avg Response Time',
    'usage.kpi.perApiRequest': 'per API request',
    'usage.kpi.efficiencyScore': 'Efficiency Score',
    'usage.kpi.compositeScore': 'composite score (0-100)',
    'usage.col.cacheRate': 'Cache Rate',
    'usage.col.tokenEff': 'Token Eff.',
    'usage.col.avgSpeed': 'Avg Speed',
    'usage.col.score': 'Score',
    'usage.chart.efficiencyTrend': 'Efficiency Trend',
    'usage.chart.efficiencyByAgent': 'Efficiency by Agent',
    'usage.noEfficiencyData': 'No efficiency data',

    // Usage — Impact tab metric labels
    'usage.impact.avgCost': 'Avg Cost',
    'usage.impact.avgTokens': 'Avg Tokens',
    'usage.impact.cacheRate': 'Cache Rate',
    'usage.impact.toolSuccess': 'Tool Success',
    'usage.impact.avgDuration': 'Avg Duration',
    'usage.impact.reqsPerSession': 'Reqs/Session',
  },
}
