...
const translations: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'settings.setup.claude.step1.desc': '셸 프로필 (~/.zshrc 또는 ~/.bashrc)에 다음을 추가합니다:',
    ...
    'settings.setup.claude.step3.desc': '에이전트, 스킬, MCP 도구 호출을 상세 추적하려면 글로벌 설정(~/.claude/settings.json)에 추가합니다:',
    ...
    'settings.setup.codex.step1.desc': '~/.codex/config.toml에 다음을 추가합니다:',
    ...
    'settings.setup.gemini.step1.desc': '~/.gemini/settings.json에 다음을 추가합니다:',
  ...
  en: {
    ...
    'settings.setup.claude.step1.desc': 'Add the following to your shell profile (~/.zshrc or ~/.bashrc):',
    ...
    'settings.setup.claude.step3.desc': 'To track agent, skill, and MCP tool calls in detail, add to the global settings (~/.claude/settings.json):',
    ...
    'settings.setup.codex.step1.desc': 'Add the following to ~/.codex/config.toml:',
    ...
    'settings.setup.gemini.step1.desc': 'Add the following to ~/.gemini/settings.json:',
